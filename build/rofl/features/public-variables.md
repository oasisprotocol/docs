...
Source: https://docs.oasis.io/build/rofl/features/public-variables
...
Such data can be passed to containers running in ROFL via *public variables*.
...
[Oasis CLI]: https://docs.oasis.io/build/tools/cli/rofl.md#public-var
