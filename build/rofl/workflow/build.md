...
The build and verify steps can also be automated in CI/CD using the
[build-deploy-rofl-action] GitHub Action. See [Deploy → GitHub
Actions](https://docs.oasis.io/build/rofl/workflow/deploy.md#github-actions) for usage examples.
