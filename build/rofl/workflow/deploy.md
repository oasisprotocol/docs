...
[sapphire]: https://docs.oasis.io/build/sapphire/network.md
...
2. Alternatively, you can copy over the ROFL bundle to your ROFL node manually
   and configure it. In this case, consult the [ROFL node → Hosting
   the ROFL bundle directly][rofl-node-hosting] section.

[ROFL node]: https://docs.oasis.io/node/run-your-node/rofl-node.md

[rofl-node-hosting]: https://docs.oasis.io/node/run-your-node/rofl-node.md#hosting-the-rofl-app-bundle-directly
