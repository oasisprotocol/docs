...
[paratime]: https://docs.oasis.io/general/oasis-network/faq.md#how-is-a-paratime-different-from-a-parachain
...
3. Switch to the Deploy tab of Remix.
   ...
   2. Make sure that Metamask is connected to the Sapphire Paratime
      (Testnet/Mainnet) network. You can read about adding a network to Metamask [here](https://docs.oasis.io/general/manage-tokens.md#metamask).
