...
```shell
oasis rofl public-var set API_URL api-url.txt
```
...
#### Import public variables from `.env` files
...
```shell
oasis rofl public-var rm API_URL
```
...
#### Change ROFL machine administrator
...
[key generation]: https://docs.oasis.io/build/rofl/features/appd.md#key-generation
...
#### Set the trust root in the app manifest
