...
<CustomDocCardSection
  ...
  description={
    <>
      ...
      <strong>EVM-compatible</strong> ParaTime with{" "}
      <strong>built-in contract state encryption</strong>. The Oasis team also
      prepared a set of libraries called the{" "}
      <a href="/build/opl/">Oasis Privacy Layer</a> to{" "}
      <strong>bridge existing dApps running on other chains</strong> and use the
      unique Sapphire's confidentiality.
      <br />
      <br />
      Our <a href="/build/rofl/">Runtime Offchain Logic (ROFL)</a> enables you to{" "}
      <strong>build secure applications running offchain</strong> in a trusted environment
      (TEE) that seamlessly communicate with Oasis Sapphire. This is ideal for trusted
