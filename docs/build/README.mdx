...
The [Oasis architecture] is designed to have a simple, robust consensus Layer 0
on top which connects a handful of Layer 1 ParaTimes executing smart contracts
which can finally integrate with off-chain apps.
