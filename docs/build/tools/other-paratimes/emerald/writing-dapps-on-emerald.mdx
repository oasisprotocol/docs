...
[Mainnet]: ../../../../node/network/mainnet.md
[Testnet]: ../../../../node/network/testnet.md
...
![Emerald block explorer showing a failed transaction](../../../images/emerald/emerald-explorer-tx.png)
