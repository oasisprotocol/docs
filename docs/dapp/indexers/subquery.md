...
SubQuery is a leading blockchain data indexer that provides developers with fast, flexible, universal, open source and decentralised APIs for web3 projects. SubQuery SDK allows developers to get rich indexed data and build intuitive and immersive decentralised applications in a faster and more efficient way. SubQuery supports 100+ ecosystems including Oasis Emerald, Oasis Sapphire, Ethereum, Near, Polygon, Polkadot, Algorand, and Avalanche.
...
- [Oasis Starter Projects](https://github.com/subquery/ethereum-subql-starter/tree/main/Oasis)
- For technical questions and support reach out to us `start@subquery.network`

## Running and Hosting your Oasis SubQuery APIs
