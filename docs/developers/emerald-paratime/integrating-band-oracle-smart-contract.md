...
3. Switch to the Deploy tab of Remix.
   ...
   2. Make sure that Metamask is connected to the Emerald (Testnet/Mainnet) network. You can read about adding Emerald network to Metamask [here](../../general/manage-tokens/how-to-transfer-rose-into-evm-paratime.mdx#metamask).
