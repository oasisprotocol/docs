...
If you have a general question on how to use and deploy our software, please read our [Run a Node](../../operators/README.mdx) section or join our [community Discord](https://discord.gg/pJdWeVtmHT).
