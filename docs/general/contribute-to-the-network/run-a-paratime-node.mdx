...
[running a ParaTime node for node operators]: /operators/set-up-your-node/run-a-paratime-node
...
* **Requires SGX**: Yes
* **Parameters:**
  * [Mainnet](/operators/mainnet#cipher-paratime)
  * [Testnet](/operators/testnet#cipher-paratime)
...
* **Requires SGX:** No
* **Parameters:**
  * [Mainnet](/operators/mainnet#emerald-paratime)
  * [Testnet](/operators/testnet#emerald-paratime)
