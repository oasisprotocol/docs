...
<DocCardList items={[
    findGeneralSidebarItem('general/manage-tokens/terminology'),
    findGeneralSidebarItem('general/manage-tokens/staking-and-delegating'),
    ...
    findGeneralSidebarItem('general/manage-tokens/holding-rose-tokens/custody-providers'),
    findGeneralSidebarItem('general/manage-tokens/holding-rose-tokens/bitpie-wallet'),
    findGeneralSidebarItem('general/manage-tokens/holding-rose-tokens/ledger-wallet'),
]} />
