...
At time of writing, Oasis CLI supports importing ed25519 keypairs only. If you need to perform token transfers and withdrawals with Ethereum keypair, use the official [Oasis Wallet Browser Extension](../../how-to-transfer-rose-into-evm-paratime.mdx) instead.
...
<DocCard item={
    findGeneralSidebarItem('general/manage-tokens/how-to-transfer-rose-into-evm-paratime')
} />
