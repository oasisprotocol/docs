...
The following commands are intended to be run on your local machine and only need access to the [network's current genesis file](../../../../operators/mainnet/README.md) and your signer's private key:
