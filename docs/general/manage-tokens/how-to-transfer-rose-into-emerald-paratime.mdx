...
<Image alt="Oasis Wallet Extension - chrome web store" img={require('./../images/wallet/ext/chrome_web_store.png')} />
...
<Image alt="Metamask - Adding Emerald Mainnet Network Configuration" img={require('./../images/wallet/metamask/settings.png')} />
