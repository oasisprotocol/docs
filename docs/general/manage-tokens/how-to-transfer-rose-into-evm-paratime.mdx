...
Currently, there are two such ParaTimes: [Emerald](/developers/emerald-paratime/) and [Sapphire](/developers/sapphire-paratime/).
...
These procedures are described in detail in [ADR 0003](../../adrs/0003-consensus-runtime-token-transfer.md).
...
You can verify your balance in [Metamask](https://metamask.io) (or a built-in wallet in the Brave browser). First, install the extension in your favorite browser and add the Emerald Mainnet/Testnet by pointing your wallet at the Web3 gateway with parameters listed [here](/developers/emerald-paratime/#web3-gateway) (Sapphire parameters can be found [here](/developers/sapphire-paratime/#web3-gateway)). Then, import your Ethereum keypair and your balance should immediately be visible.
...
<DocCardList items={[
    newItem('Writing dApps on Emerald', '/developers/emerald-paratime/writing-dapps-on-emerald'),
    newItem('Writing dApps on Sapphire', '/developers/sapphire-paratime/writing-dapps-on-sapphire'),
]} />
