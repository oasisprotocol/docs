...
listed [here](/developers/emerald/#web3-gateway) (Sapphire
parameters can be found [here](/developers/sapphire/#web3-gateway)). Then,
...
[compute nodes](../../operators/run-your-node/paratime-node.mdx)) may need to
...
<DocCardList items={[
    findSidebarItem('/developers/emerald/writing-dapps-on-emerald'),
    findSidebarItem('/developers/sapphire/writing-dapps-on-sapphire'),
