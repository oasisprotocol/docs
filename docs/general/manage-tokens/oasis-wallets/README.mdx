...
The [Oasis Foundation](https://oasisprotocol.org) supports two first-party non-custodial wallets, a [web wallet](https://wallet.oasis.io) named [Oasis Wallet -Web](https://github.com/oasisprotocol/oasis-wallet-web/) and a browser extension wallet named Oasis Wallet - Browser Extension. Both seamlessly connect to the [Oasis Network](../../oasis-network/README.mdx) and makes it easy to hold, send, and receive ROSE tokens.
...
The [Oasis Wallet - Web](https://github.com/oasisprotocol/oasis-wallet-web/) can be found at [wallet.oasis.io](https://wallet.oasis.io).
...
<DocCard item={findSidebarItem('/general/manage-tokens/faq')} />
