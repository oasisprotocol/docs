...
* Easily switching between different Oasis Wallets that use the same [ADR 0008](/adrs/0008-standard-account-key-generation) standard account key generation process
