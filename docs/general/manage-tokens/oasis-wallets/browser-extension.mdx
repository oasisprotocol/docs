...
Click on your Ledger device. Then click "Connec Ledger device".
...
![Buy tokens directly from the wallet](../../images/wallet/ext/account_options.png)
...
[ROSE Wallet - Browser Extension](https://github.com/oasisprotocol/oasis-wallet-ext/), you
can [submit a GitHub issue](https://github.com/oasisprotocol/oasis-wallet-ext/issues),
