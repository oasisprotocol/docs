...
text area. The Oasis wallet will check for any typos and missing words. When
...
password each time you will open the Oasis Wallet - Web.
...
Oasis Wallet - Web uses English mnemonic phrase words as defined in
...
The Oasis Wallet team integrated a 3rd party [Transak](https://transak.com/)
...
[Oasis Wallet - Web](https://github.com/oasisprotocol/oasis-wallet-web/), you
