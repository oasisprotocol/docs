...
[network-parameters-paratimes]: ../../network-parameters/mainnet#paratimes
...
* This upgrade will upgrade **Oasis Core** to version **21.2.8** which:
  * Upgrades the BadgerDB database backend from v2 to v3. See [**BadgerDB v2 to v3 Migration**](upgrade-log-mainnet.md#badgerdb-v2-to-v3-migration) section for required steps to be done before upgrade.
...
* [Wipe state](../../run-your-node/maintenance/wiping-node-state.md#state-wipe-and-keep-node-identity).
* Update your node's configuration per instructions in [Configuration changes](upgrade-log-mainnet.md#configuration-changes) below.
* Start your node.
