...
* See [Before upgrade](upgrade-log-testnet.md#before-upgrade) section for required steps
...
* If the nodes are running any ParaTimes, make sure you upgrade to the versions
  published on the [Testnet network parameters page](../../network-parameters/testnet.md).
...
published on the [Testnet network parameters page](../../network-parameters/testnet.md) for their respective
ParaTimes.
...
* See [Before upgrade](upgrade-log-testnet.md#before-upgrade) section for required steps to be done before upgrade.
...
* Runtime operators see [Before upgrade](upgrade-log-testnet.md#before-upgrade) section for required steps to be done before upgrade.
