...
Alternatively, if you want to modify the permissions of `/dev/sgx_enclave`
generated by your system, consider adding the following udev rule into
`/etc/udev/rules.d/50-sgx.rules`:

```bash
# Permissions to SGX devices
SUBSYSTEM=="misc", KERNEL=="sgx_enclave", GROUP="oasis", MODE="0660"
```
