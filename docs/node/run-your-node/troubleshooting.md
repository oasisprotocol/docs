...
* Check that your current binary version matches the version listed on the Network Parameters page ([Mainnet](../network-parameters/mainnet.md), [Testnet](../network-parameters/testnet.md))
