...
[`oasis wallet import-file`]: ../../build/tools/cli/wallet.md#import-file
[`oasis account entity init`]: ../../build/tools/cli/account.md#entity-init
[`oasis wallet show`]: ../../build/tools/cli/wallet.md#show
...
[`oasis account delegate`]: ../../build/tools/cli/account.md#delegate
...
[`oasis account entity register`]: ../../build/tools/cli/account.md#entity-register
...
[`scheduler.max_validators`]: ../reference/genesis-doc.md#consensus
...
<DocCardList items={[
    findSidebarItem('/build/tools/cli/'),
