...
<DocCardList items={[
    ...
    findSidebarItem('/operators/run-your-node/prerequisites'),
    findSidebarItem('/operators/run-your-node/validator-node/'),
    findSidebarItem('/operators/run-your-node/non-validator-node'),
]} />
