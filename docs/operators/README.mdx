...
<DocCardList items={[
    findSidebarItem('/operators/mainnet/upgrade-log'),
    findSidebarItem('/operators/set-up-your-node/prerequisites'),
    findSidebarItem('/operators/set-up-your-node/run-validator'),
    findSidebarItem('/operators/set-up-your-node/run-non-validator'),
]} />
