...
<DocCardList items={[ // TODO
//    findSidebarItem('prerequisites'),
//    findSidebarItem('upgrade-log'),
//    findSidebarItem('set-up-your-node/run-validator'),
//    findSidebarItem('set-up-your-node/run-non-validator'),
]} />
