...
Deregistered entities can always re-register by submitting the [entity registration transaction](../../set-up-your-node/run-validator.md#generating-entity-registration-transaction) after the upgrade.
