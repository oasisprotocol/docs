...
If you are looking for some concrete ParaTimes that you can run, see [the list of ParaTimes and their parameters](../../general/contribute-to-the-network/run-a-paratime-node.mdx).
