...
[unmnemonic-tool-faq]: https://docs.oasis.io/general/manage-tokens/faq.md#i-lost-my-ledger-or-my-ledger-is-broken-i-urgently-need-to-access-my-assets-can-i-import-ledger-mnemonic-into-rose-wallet
...
* [ROSE Wallet - Web: Import Ledger account](https://docs.oasis.io/general/manage-tokens/oasis-wallets/web.md#import-an-existing-account)
* [ROSE Wallet - Browser extension: Ledger](https://docs.oasis.io/general/manage-tokens/oasis-wallets/browser-extension.md#import-an-existing-account)
