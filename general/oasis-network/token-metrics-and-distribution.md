...
For more details, see its [Delegation Policy](https://docs.oasis.io/get-involved/delegation-policy.md).

## Change Log

* **Mar 27, 2024:**
  * Updated Staking Rewards Schedule after the
    [governance proposal #4](https://explorer.oasis.io/mainnet/consensus/proposal/4) passed (Mar
