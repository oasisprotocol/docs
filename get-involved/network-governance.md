...
read our [Run a Node](https://docs.oasis.io/node.md) section or join our
[community Discord](https://docs.oasis.io/get-involved.md).
...
[here](https://docs.oasis.io/get-involved/oasis-core.md).
...
* **Proposals.** for features and roadmap updates can come from anyone in the
  ...
  ([for minor features](https://docs.oasis.io/get-involved/network-governance.md#minor-feature-requests)) or
  [Architectural Decision Records](https://docs.oasis.io/adrs.md) (ADRs,
  [for major features](https://docs.oasis.io/get-involved/network-governance.md#major-feature-requests)).
* **Review and discussion of the proposals.** Decisions about the future of the
  ...
  ([for minor features](https://docs.oasis.io/get-involved/network-governance.md#minor-feature-requests)) and ADRs
  ([for major features](https://docs.oasis.io/get-involved/network-governance.md#major-feature-requests)).
...
[proposing an Architectural Decision Record (ADR)](https://docs.oasis.io/adrs.md) and submit it as
...
[review our contribution guidelines here.](https://docs.oasis.io/get-involved/oasis-core.md).
