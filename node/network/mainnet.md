...
* Genesis document's hash ([explanation](https://docs.oasis.io/node/reference/genesis-doc.md#genesis-file-vs-genesis-document)):
...
* [Oasis Core](https://github.com/oasisprotocol/oasis-core) version:
  * [26.1](https://github.com/oasisprotocol/oasis-core/releases/tag/v26.1)
* [Oasis Rosetta Gateway](https://github.com/oasisprotocol/oasis-rosetta-gateway) version:
  * [2.8.0](https://github.com/oasisprotocol/oasis-rosetta-gateway/releases/tag/v2.8.0)
...
If you want to join our Testnet, see the [Testnet](https://docs.oasis.io/node/network/testnet.md) docs
...
Check the [Emerald ParaTime page](https://docs.oasis.io/build/tools/other-paratimes/emerald/network.md#rpc-endpoints) on how to access
