...
[Genesis Document](https://docs.oasis.io/core/consensus/genesis.md) part of Oasis Core's developer
documentation.

The important thing to note is that the genesis document is used to compute the
[genesis document's hash](https://docs.oasis.io/core/consensus/genesis.md#genesis-documents-hash).
...
[Cobalt upgrade](https://docs.oasis.io/node/reference/upgrades/cobalt-upgrade.md) the height of the
...
[runtime governance models]: https://docs.oasis.io/core/consensus/services/registry.md#runtimes
...
[Root Hash service]: https://docs.oasis.io/core/consensus/services/roothash.md

[messages]: https://docs.oasis.io/core/runtime/messages.md

[compute node slashing]: https://docs.oasis.io/adrs/0005-runtime-compute-slashing.md
...
* **`staking.params.allow_escrow_messages`** Indicator whether to enable support
  for `AddEscrow` and `ReclaimEscrow` [runtime messages](https://docs.oasis.io/core/runtime/messages.md).
...
[Staking Incentives]: https://docs.oasis.io/general/oasis-network/token-metrics-and-distribution.md#staking-incentives
...
[scheduled]: https://docs.oasis.io/core/consensus/services/roothash.md
...
* **`beacon.base`** Network's starting epoch. When a network is upgraded, its
  epoch is retained. For example, for the [Cobalt upgrade](https://docs.oasis.io/node/reference/upgrades/cobalt-upgrade.md)
...
[on-chain governance](https://docs.oasis.io/core/consensus/services/governance.md) introduced in
the [Cobalt upgrade](https://docs.oasis.io/node/reference/upgrades/cobalt-upgrade.md):
