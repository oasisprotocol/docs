...
[Eden Upgrade]: https://docs.oasis.io/node/reference/upgrades/eden-upgrade.md
...
* **`extra_data`** will be set back to the value in the [Mainnet genesis file]
  ...
  *”*[*Quis custodiet ipsos custodes?*][mainnet-quote]*” \[submitted by Oasis
...
[Genesis Document]: https://docs.oasis.io/node/reference/genesis-doc.md#parameters
...
[upgrade governance proposal]: https://docs.oasis.io/core/consensus/services/governance.md#submit-proposal

[your entity's nonce]: https://docs.oasis.io/build/tools/cli/account.md#show

[Oasis node CLI Tools Setup]: https://docs.oasis.io/core/oasis-node/cli.md

[Installing Oasis App on Your Ledger Wallet]: https://docs.oasis.io/general/manage-tokens/holding-rose-tokens/ledger-wallet.md
...
[change-to-non-root]: https://docs.oasis.io/node/run-your-node/prerequisites/system-configuration.md#create-a-user
...
[Damask Upgrade]: https://docs.oasis.io/node/reference/upgrades/damask-upgrade.md#proposed-state-changes

[Damask upgrade release]: https://github.com/oasisprotocol/mainnet-artifacts/releases/tag/2022-04-11

[Handling Network Upgrades]: https://docs.oasis.io/node/run-your-node/maintenance/handling-network-upgrades.md#verify-genesis
...
[Wipe state]: https://docs.oasis.io/node/run-your-node/maintenance/wiping-node-state.md#state-wipe-and-keep-node-identity
...
[network-paratimes]: https://docs.oasis.io/node/network/mainnet.md#paratimes
...
This upgrade will be the first upgrade that will use the new on-chain governance service introduced in the [Cobalt Upgrade](https://docs.oasis.io/node/reference/upgrades/cobalt-upgrade.md).

The Oasis Protocol Foundation has submitted an [upgrade governance proposal](https://docs.oasis.io/core/consensus/services/governance.md#submit-proposal) with the following contents:
...
Obtain [your entity's nonce](https://docs.oasis.io/build/tools/cli/account.md#show) and store it in the `NONCE` variable. You can do that by running:
...
* This upgrade will upgrade **Oasis Core** to version **21.2.8** which:
  * Upgrades the BadgerDB database backend from v2 to v3. See [**BadgerDB v2 to v3 Migration**](https://docs.oasis.io/node/reference/upgrade-logs/mainnet.md#badgerdb-v2-to-v3-migration) section for required steps to be done before upgrade.
  * Has a check that makes sure the **file descriptor limit** is set to an appropriately high value (at least 50000). While previous versions only warned in case the limit was set too low, this version will refuse to start. Follow the [File Descriptor Limit](https://docs.oasis.io/node/run-your-node/prerequisites/system-configuration.md#increase-file-descriptor-limit) documentation page for details on how to increase the limit on your system.
...
* To ensure your node will stop at epoch **5046** [submit the following upgrade descriptor](https://docs.oasis.io/build/tools/cli/network.md#governance-create-proposal) at any time before the upgrade:
...
* Verify the provided Cobalt upgrade genesis file by comparing it to network state dump. See instructions in the [Handling Network Upgrades](https://docs.oasis.io/node/run-your-node/maintenance/handling-network-upgrades.md#verify-genesis) guide.
...
For more detailed instructions, see the [Handling Network Upgrades](https://docs.oasis.io/node/run-your-node/maintenance/handling-network-upgrades.md) guide.
...
* Download [Oasis Node](https://docs.oasis.io/node/run-your-node/prerequisites/oasis-node.md) version [20.12.2](https://github.com/oasisprotocol/oasis-core/releases/tag/v20.12.2), while continuing to run version 20.10.x.
...
* (optional) Verify the provided Mainnet genesis file by comparing it to network state dump. See instructions in the [Handling Network Upgrades](https://docs.oasis.io/node/run-your-node/maintenance/handling-network-upgrades.md#verify-genesis) guide.
* Replace the old Mainnet Beta genesis file with the Mainnet genesis file.
* Stop your node.
* Remove the old 20.10.x version of Oasis Node.
* [Wipe state](https://docs.oasis.io/node/run-your-node/maintenance/wiping-node-state.md#state-wipe-and-keep-node-identity).
* Update your node's configuration per instructions in [Configuration changes](https://docs.oasis.io/node/reference/upgrade-logs/mainnet.md#configuration-changes) below.
* Start your node.

**Info**:

This time, we recommend dumping the network state with the upgraded Oasis Node binary so that the genesis file will be in the [canonical form](https://docs.oasis.io/core/consensus/genesis.md#canonical-form).
