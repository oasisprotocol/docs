...
[Governance documentation]: https://docs.oasis.io/build/tools/cli/network.md#governance-cast-vote
...
* See [Before upgrade](https://docs.oasis.io/node/reference/upgrade-logs/testnet.md#before-upgrade) section for required steps
...
* (optional) Vote for the upgrade. On 2022-04-01, an upgrade proposal will be
  ...
  See the [Governance documentation](https://docs.oasis.io/build/tools/cli/network.md#governance-cast-vote)
...
* If the nodes are running any ParaTimes, make sure you upgrade to the versions
  published on the [Testnet network parameters page](https://docs.oasis.io/node/network/testnet.md).
...
[Handling Network Upgrades]: https://docs.oasis.io/node/run-your-node/maintenance/handling-network-upgrades.md
...
* (optional) Vote for the upgrade. On 2022-03-02, an upgrade proposal will be proposed which (if accepted) will schedule the upgrade on epoch **14209.** See the [Governance documentation](https://docs.oasis.io/build/tools/cli/network.md#governance-cast-vote) for details on voting for proposals.
...
published on the [Testnet network parameters page](https://docs.oasis.io/node/network/testnet.md) for their respective
ParaTimes.
...
[ADR 0010]: https://docs.oasis.io/adrs/0010-vrf-elections.md

[pvss-beacon]: https://docs.oasis.io/adrs/0007-improved-random-beacon.md
...
[minimum staking thresholds]: https://docs.oasis.io/node/reference/genesis-doc.md#staking-thresholds
...
* See [Before upgrade](https://docs.oasis.io/node/reference/upgrade-logs/testnet.md#before-upgrade) section for required steps to be done before upgrade.
* (optional) Vote for the upgrade. On 2021-06-21, an upgrade proposal will be proposed which (if accepted) will schedule the upgrade on epoch **7553.** See the [Governance documentation](https://docs.oasis.io/build/tools/cli/network.md#governance-cast-vote) for details on voting for proposals.
...
* Runtime operators see [Before upgrade](https://docs.oasis.io/node/reference/upgrade-logs/testnet.md#before-upgrade) section for required steps to be done before upgrade.
* (optional) Vote for the upgrade. On 2021-04-12 an upgrade proposal will be proposed which (if accepted) will schedule a network shutdown on epoch **5662.** See the [Governance documentation](https://docs.oasis.io/build/tools/cli/network.md#governance-cast-vote) for details on voting for proposals.
...
* (optional) To ensure your node will stop at epoch **5128** [submit the following upgrade descriptor](https://docs.oasis.io/build/tools/cli/network.md#governance-create-proposal) at any time before the upgrade:
...
* (optional) Verify the provided Testnet genesis file by comparing it to network state dump. See instructions in the [Handling Network Upgrades](https://docs.oasis.io/node/run-your-node/maintenance/handling-network-upgrades.md#verify-genesis) guide.
* Replace the old genesis file with the new Testnet genesis file.
