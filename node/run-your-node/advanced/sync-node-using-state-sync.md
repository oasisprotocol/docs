...
[validator node](https://docs.oasis.io/node/run-your-node/validator-node.md) or a
[non-validator node](https://docs.oasis.io/node/run-your-node/non-validator-node.md)) by initializing it from the
...
[copy state from one node to the other]: https://docs.oasis.io/node/run-your-node/advanced/copy-state-from-one-node-to-the-other.md
...
Browse to one of our block explorers (e.g. [Oasis Explorer]) and obtain the
