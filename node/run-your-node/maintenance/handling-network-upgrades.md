...
[governance proposal]: https://docs.oasis.io/build/tools/cli/network.md#governance-cast-vote

Once the upgrade epoch is reached, follow the instructions in the corresponding
[upgrade log].

[upgrade log]: https://docs.oasis.io/node/reference/upgrade-logs/mainnet.md

[Mainnet]: https://docs.oasis.io/node/network/mainnet.md

[Testnet]: https://docs.oasis.io/node/network/testnet.md

[Testnet upgrade 2022-04-04]: https://docs.oasis.io/node/reference/upgrade-logs/testnet.md#2022-04-04-upgrade

[Testnet upgrade 2022-03-03]: https://docs.oasis.io/node/reference/upgrade-logs/testnet.md#2022-03-03-upgrade

[Testnet upgrade 2021-08-11]: https://docs.oasis.io/node/reference/upgrade-logs/testnet.md#2021-08-11-upgrade

[Mainnet upgrade 2022-04-11 (Damask)]: https://docs.oasis.io/node/reference/upgrade-logs/mainnet.md#damask-upgrade

[Mainnet upgrade 2021-08-31]: https://docs.oasis.io/node/reference/upgrade-logs/mainnet.md#2021-08-31-upgrade

[Mainnet upgrade 2021-04-28 (Cobalt)]: https://docs.oasis.io/node/reference/upgrade-logs/mainnet.md#cobalt-upgrade
...
[Cobalt upgrade's Proposed State Changes]: https://docs.oasis.io/node/reference/upgrades/cobalt-upgrade.md#proposed-state-changes

[Damask upgrade's Proposed State Changes]: https://docs.oasis.io/node/reference/upgrades/damask-upgrade.md#proposed-state-changes
...
* `extra_data`: This field can hold network's extra data, but is currently
  ...
  *”*[*Quis custodiet ipsos custodes?*](https://en.wikipedia.org/wiki/Quis_custodiet_ipsos_custodes%3F)*” \[submitted by Oasis Community Member Daniyar Borangaziyev].*
...
[Token Metrics and Distribution]: https://docs.oasis.io/general/oasis-network/token-metrics-and-distribution.md
...
[Wiping Node State](https://docs.oasis.io/node/run-your-node/maintenance/wiping-node-state.md#state-wipe-and-keep-node-identity)
document.
...
[`oasis network show paratimes`]: https://docs.oasis.io/build/tools/cli/network.md#show-paratimes
...
can start the [Oasis Node](https://docs.oasis.io/node/run-your-node/prerequisites/oasis-node.md) like this:
