...
[roles]: https://docs.oasis.io/node.md#validator-and-paratime-nodes
...
If you intend to [run a ParaTime node](https://docs.oasis.io/node/run-your-node/paratime-node.md) you will need to
