...
[`oasis rofl provider create`]: https://docs.oasis.io/build/tools/cli/rofl.md#provider-create
...
#### Multiple ROFL replicas on a single node
...
#### Limit an offer to specific ROFL creators
...
[`oasis rofl provider update-offers`]: https://docs.oasis.io/build/tools/cli/rofl.md#provider-update-offers
