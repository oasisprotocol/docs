...
* Check that your current binary version matches the version listed on the Network Parameters page ([Mainnet](https://docs.oasis.io/node/network/mainnet.md), [Testnet](https://docs.oasis.io/node/network/testnet.md))
...
* If you're doing anything with the entity:
  ...
  * If you're signing a transaction:
    * Check your account balance and nonce using the [`oasis account show`](https://docs.oasis.io/build/tools/cli/account.md#show) command.
...
[tee-dcap-attestation]: https://docs.oasis.io/node/run-your-node/prerequisites/set-up-tee.md#dcap-attestation
...
[tee-dcap-quote-provider]: https://docs.oasis.io/node/run-your-node/prerequisites/set-up-tee.md#configuring-the-quote-provider
...
[tee-multi-socket-systems]: https://docs.oasis.io/node/run-your-node/prerequisites/set-up-tee.md#multi-socket-systems
...
[rofl-yaml-storage]: https://docs.oasis.io/build/rofl/features/manifest.md#resources-storage
