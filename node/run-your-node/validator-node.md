...
For example the [ROSE Wallet - Web] and the [Oasis Explorer] will fetch and
show the node operator's name and the avatar.

[Metadata Registry]: https://github.com/oasisprotocol/metadata-registry

[ROSE Wallet - Web]: https://wallet.oasis.io

[Oasis Explorer]: https://explorer.oasis.io/mainnet/consensus/validators
