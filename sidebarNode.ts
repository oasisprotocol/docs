      ...
      items: [
        {
          ...
          link: {
            type: "generated-index",
            description: "This section lists hardware and software prerequisites for running an Oasis node.",
        ...
        "node/run-your-node/rofl-node",
        {
          ...
          items: ["node/run-your-node/keymanager-node/signing-key-manager-policy", "node/run-your-node/keymanager-node/key-manager-upgrade"],
        },
