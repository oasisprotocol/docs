...
export const sidebarNode: SidebarsConfig = {
  operators: [
    ...
    },
    {
      ...
      link: {
        type: 'doc',
        id: 'node/network-parameters/README',
      },
      items: [
        'node/network-parameters/mainnet',
        'node/network-parameters/testnet',
      ],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            'node/reference/upgrade-logs/upgrade-log-mainnet',
            'node/reference/upgrade-logs/upgrade-log-testnet',
          ],
        },
      ],
    },
